...
| Backup | O formato v3 cobre os dados atuais do SGE, mas a restauração ainda ocorre em várias chamadas do cliente e não inclui objetos do Storage. | Uma falha pode deixar estado parcial; anexos exigem exportação separada. |
...
4. Criar restauração transacional e incluir os objetos do Storage, ou manter a exportação separada explicitamente documentada.
