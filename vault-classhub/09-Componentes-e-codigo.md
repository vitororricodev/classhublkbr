...
- A barra de navegação lateral rola internamente em telas baixas; usa a classe `sidebar-scroll` com indicador minimalista, revelado ao passar o mouse, e coerente com o fundo escuro.
